...
The [testing pyramid](/docs/evals/testing-pyramid) gives a useful discipline: promote the failure to the lowest layer that can prevent it, and retain one end-to-end case to prove the layers still compose.
...
Next: [Operating It](/docs/capstone/operating-it), the first month, where the same failures arrive without asking permission.
