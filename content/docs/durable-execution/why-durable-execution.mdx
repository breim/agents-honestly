...
Next: [Temporal in Forty Minutes](/book/durable-execution/temporal-in-forty-minutes). Workflows, activities, workers, task queues, event history, replay: the whole mental model, quickly.
