...
Replay is what makes all six nouns work, and replay has rules a workflow can break without saying so. Next: [Determinism, Retries, and Timers](/book/durable-execution/determinism-and-retries), the constraints, and the knobs you will actually turn.
