...
Next: [Signals, Updates, and Child Workflows](/book/durable-execution/signals-and-children), getting data into a running workflow, getting answers out, and decomposing the big ones.
