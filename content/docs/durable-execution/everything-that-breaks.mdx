...
The list of what breaks is written down now, and every item on it has been solved before, separately, badly. Next: [Why Durable Execution](/book/durable-execution/why-durable-execution), which is the system you would have arrived at yourself, three incidents later.
