...
Next: [The Reference Architecture](/docs/production/reference-architecture), turning the approved purpose, authority, evidence, and ownership into deployed components.
