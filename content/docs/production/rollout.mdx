...
You deploy at 14:00. At that instant [Atlas](/book/preface#what-youll-build) has 3,000 runs in flight, one per open support ticket: some four seconds old, some four hours old, and eleven that have been paused since Tuesday waiting on an approval.
...
The ladder gets a change to everybody safely, and then everybody uses it. Next: [Cost Engineering](/book/production/cost-engineering), where the pilot's per-ticket price meets real volume and produces a number nobody budgeted.
