...
Everything in Part XVIII so far describes a system already carrying traffic. Next: [The Go-Live Readiness Review](/book/production/go-live-readiness-review), the gate it should have passed first, and the evidence each answer needs behind it.
