...
An architecture that can say what happened still has to say which version of itself did it. Next: [Versioning Prompts, Models, and Graphs](/book/production/versioning), because the git SHA identifies your code and not what the model was given.
