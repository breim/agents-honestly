...
The first month [Atlas](/book/preface#what-youll-build) works Meridian Supply's support queue at real volume, someone forecasts the annual bill from the pilot's per-ticket cost and gets a number nobody budgeted.
...
Deployed, versioned, rolled out and priced, and nobody has been woken up by it yet. Next: [The Operating Manual](/book/production/operating-manual), on dashboards, incident shapes, and being on call for something probabilistic.
