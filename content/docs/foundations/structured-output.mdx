...
A schema guarantees shape and nothing else. Next: [Why Your Agent Is Flaky](/book/foundations/nondeterminism), where the guarantee you actually wanted, the same input producing the same output, turns out not to be for sale.
