...
Next: [Choosing and Adapting Models](/book/foundations/choosing-and-adapting-models), choosing by measured task fit, and knowing when a model change is the wrong fix.
