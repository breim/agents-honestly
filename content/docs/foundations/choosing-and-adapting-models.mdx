...
Next: [When Not to Build an Agent](/book/foundations/when-not-to-build-an-agent). The cheapest agent is the one you replaced with three if-statements and a good prompt.
