...
[Atlas](/book/preface#what-youll-build) can call tools, browse portals, and recover from failures. Now Meridian Supply asks it to fix a failing carrier adapter. The request sounds like one more tool: give the model a shell and a repository.
