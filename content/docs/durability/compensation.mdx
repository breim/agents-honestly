...
One case, unwound correctly. Next: [Scale and Quality of Service](/book/durability/scale-and-qos), where there are thousands at once, the provider quota is shared, and one tenant's Monday can starve everybody else's.
