...
Priority and fairness both spend time deciding what runs next, and time is what an eight-minute run has least of. Next: [Paying for Durability in Milliseconds](/book/durability/latency), on where the overhead is real and where it vanishes into the model call.
