...
Every version of Atlas so far starts, works one ticket, and ends inside ten minutes. Next: [Long-Lived Agents](/book/durability/long-lived-agents), where the customer replies on Thursday and the case has to still be there.
