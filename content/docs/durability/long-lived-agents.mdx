...
A case that stays alive for weeks accumulates effects that no replay can take back. Next: [When Tools Have Side Effects](/book/durability/compensation), where step two fails after step one has already moved the money.
