...
Next: [Mapping Temporal Patterns to Agent Patterns](/book/durability/temporal-pattern-map), a direct cross-reference from the Temporal design-pattern catalog to the agent problem each one solves.
