...
The objections are answered and no code has moved yet. Next: [The Agent as a Workflow](/book/durability/agent-as-workflow), the same eighty lines from Part II, with the loop as a workflow and every effect as an activity.
