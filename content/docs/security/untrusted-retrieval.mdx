...
[Atlas](/book/preface#what-youll-build) answers Meridian Supply's refund and policy questions out of a help-center corpus of about forty thousand chunks. Most of it is written by the docs team. Some of it is community-contributed answers, migrated in during last year's forum consolidation and never looked at again.
...
Two chapters have now established that hostile text will reach the model, and neither has reduced what the model may do about it. Next: [Excessive Agency and Least Privilege](/book/security/least-privilege), which is the half of the problem you can actually close.
