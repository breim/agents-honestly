...
Taint tracking assumes you can tell which text is untrusted at the moment it arrives. Next: [Retrieved Text Is Untrusted Input](/book/security/untrusted-retrieval), where the hostile sentence has been sitting in your own index for eleven months, correctly ingested, waiting for a query that matches.
