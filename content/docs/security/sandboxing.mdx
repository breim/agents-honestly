...
Everything in this part so far assumes the system you audited is the system that runs. Next: [The Agentic Supply Chain](/book/security/agentic-supply-chain), where a catalogue updated overnight changes what Atlas can do without a deploy.
