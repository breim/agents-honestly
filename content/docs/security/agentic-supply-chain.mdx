...
No code changed, but [Atlas](/book/preface#what-youll-build) started calling a new tool from the middle of a support ticket.
...
Next: [Adversarial Evals and Red Teaming](/book/security/adversarial-evals), testing what a compromised component can induce across the whole trajectory.
