...
Next: [Wiring the UI to a Durable Backend](/book/interface/ui-to-durable-backend). Start, signal, query, reconnect: a React front end over agents that outlive the browser tab.
