...
It streams, it survives a refresh, and none of that decides whether a person is willing to rely on it. Next: [Interface Patterns for Trust](/book/interface/trust-patterns), the vocabulary that makes an agent usable by somebody who starts out sceptical.
