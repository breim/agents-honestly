...
Next: [Realtime Voice Agents](/book/interface/realtime-voice-agents), applying the same state, authority, and accessibility rules when the interface is a live conversation.
