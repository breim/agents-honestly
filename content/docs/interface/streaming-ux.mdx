...
One rule was stated there and left unpaid: a tool call is a structured element rather than text. Next: [Generative UI and Tool Approvals](/book/interface/generative-ui-and-approvals), which is what it costs to mean that, and where the approval gate belongs once you do.
