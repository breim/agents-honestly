...
Next: [Two Durable Runtimes, One System](/docs/interface/two-durable-runtimes), choosing which runtime owns work that must survive the voice or browser session.
