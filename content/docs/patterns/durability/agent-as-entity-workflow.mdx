...
<Figure caption="The workflow holds position and state across weeks. Each blocking wait costs nothing while idle; only activities consume a worker." frame={false}>
