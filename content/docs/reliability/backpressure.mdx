...
Everything Part XVI has built is a claim about behaviour under conditions nobody has produced yet. Next: [Failure Injection](/book/reliability/failure-injection), on producing them deliberately, before production produces them at 03:00.
