...
Atlas survives a provider outage, a duplicated call, a starved queue and a killed worker, each of them proven by breaking it on purpose. All of it assumed the failures were accidents. Next: [The Threat Model](/book/security/threat-model), Part XVII, where somebody is causing them and choosing which of your components to use.
