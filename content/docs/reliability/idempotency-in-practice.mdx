...
Next: [Fallbacks and Circuit Breakers](/book/reliability/fallbacks-and-breakers). Degrading to a smaller model, another provider, or a human, instead of failing.
