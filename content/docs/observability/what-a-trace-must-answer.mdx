...
Next: [OpenTelemetry for GenAI](/book/observability/otel-genai), the semantic conventions for models, tokens, retrieval, and tool calls, and instrumenting the whole stack against them.
