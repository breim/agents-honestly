...
A trace tells you what happened. It cannot tell you what a fix would have done instead. Next: [Replay-Driven Debugging](/book/observability/replay-debugging), where the event history becomes the fixture and last Tuesday runs again against today's code.
