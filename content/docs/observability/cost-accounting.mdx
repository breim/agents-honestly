...
Cost moves when somebody changes something. Quality moves when nobody does. Next: [Detecting Drift](/book/observability/drift), on telling apart a model that changed, data that changed, and users who changed.
