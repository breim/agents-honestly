...
The specification is written, the twenty tickets have known answers, and nothing has been built. Next: [One Call, Then Structure](/book/first-agent/one-call), where the smallest possible thing gets scored against that set before anyone calls it an agent.
