...
Next: [Context as an Allocation Problem](/book/context/context-as-budget). Every claimant competes for the same space, and deciding who gets it is an engineering decision rather than a default.
