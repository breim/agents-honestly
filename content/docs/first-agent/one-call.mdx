...
Nineteen of twenty classified, none resolved, and no wording closes that gap. Next: [One Tool, Then Many](/book/first-agent/first-tools), where the model gets a way to go and fetch the fact it was never given.
