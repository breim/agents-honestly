...
Three things were deferred to make that argument cleanly. Next: [Servers, Clients, Transports](/book/mcp/servers-clients-transports), where they turn out to be one thing wearing three names.
