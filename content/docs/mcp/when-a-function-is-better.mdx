...
| --- | --- |
| A new "unknown" outcome | [The third state](/book/tools/idempotency): succeeded, failed, *unknown*. Now reachable through one more network |
...
| Version skew | Revisions differ meaningfully, and mismatches [surface as behaviour rather than errors](/book/mcp/servers-clients-transports) |
| Descriptions you do not own | [Selection accuracy](/book/tools/tool-discovery) driven by prose you did not write and cannot review |
...
[The test from the first chapter of this part](/book/mcp/what-mcp-is) still resolves it fastest: *what breaks if you delete the protocol and paste the tool definitions into your own catalogue?* If the answer is "I would be maintaining an integration someone else currently maintains," keep it. If the answer is "nothing," you have found the boundary that should not exist.
...
Next: [MCP Is Not A2A](/book/mcp/remote-agents-and-a2a), where the remote system accepts a delegated task instead of exposing a tool.
