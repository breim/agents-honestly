...
Part IX ends here. Next: [Why Durable Execution](/docs/durable-execution/why-durable-execution), because a remote task does not remove the need for a durable local business process.
