...
Nodes returned partial updates and something merged them, quietly, without being asked how. Next: [Reducers and State Schemas](/book/langgraph/reducers-and-state), which is where graphs go subtly wrong.
