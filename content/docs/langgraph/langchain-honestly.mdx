...
Adopting per capability means starting with the one that earns it, and for this book that is the graph. Next: [State, Nodes, Edges](/book/langgraph/state-nodes-edges), three primitives, and Atlas rebuilt as a state machine you can point at.
