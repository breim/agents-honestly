...
Every shape here assumed you already knew which one the request needed. Next: [Routing and Orchestration](/book/workflows/routing-and-orchestration), on making that choice explicit, and keeping it out of the model's hands.
