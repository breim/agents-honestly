...
Next: [Evaluator–Optimizer Loops](/book/workflows/evaluator-optimizer). Generate, critique, revise: the loop that improves output without becoming an open-ended agent.
