...
Sorting the steps into columns says nothing about how they join up. Next: [Sequential, Parallel, Fan-Out](/book/workflows/composition-patterns), the handful of shapes that cover most of what people reach for an agent to do.
