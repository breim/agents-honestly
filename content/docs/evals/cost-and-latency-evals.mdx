...
Next: [Continuous Integration for Agents](/book/evals/ci-for-agents), regression gates on a stochastic system: sample sizes, variance, flake budgets, statistical honesty.
