...
Those extra steps had a price, and nothing in the suite has charged for it yet. Next: [Cost and Latency as Scores](/book/evals/cost-and-latency-evals), where ninety seconds and a dollar is a failing result however right the answer was.
