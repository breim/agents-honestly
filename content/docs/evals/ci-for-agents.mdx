...
A gate lets through anything smaller than it can measure, which leaves a debt this part has to settle somewhere else. Next: [Online Evals and Guardrails](/book/evals/online-evals), where the traffic is free, plentiful, and already in front of customers.
