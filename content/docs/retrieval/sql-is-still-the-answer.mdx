...
Every route in Part IV so far has assumed its index was already there and already correct. Next: [Building the Ingestion Pipeline](/book/retrieval/ingestion-pipeline), the least written-about part of retrieval and the one that sets its ceiling.
