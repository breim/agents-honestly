...
Next: [Hybrid Search and Reranking](/book/retrieval/hybrid-and-reranking), fusing lexical and semantic candidates, then reranking for what actually answers the question.
