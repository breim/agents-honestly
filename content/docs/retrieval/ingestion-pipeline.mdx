...
The pipeline is reproducible as long as every source is text. Next: [Multimodal Document Intelligence](/book/retrieval/multimodal-document-intelligence), where one PDF holds a scan, a chart, and a table whose headers repeat after the page break.
