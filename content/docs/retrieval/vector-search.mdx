...
Next: [Approximate Search, Honestly](/book/retrieval/ann-indexes), covering HNSW, IVF, quantization, and the recall / latency / memory / build-time quadrilemma you are actually choosing between.
