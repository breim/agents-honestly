...
Next: [Chunking](/book/retrieval/chunking), covering fixed, recursive, semantic, document-aware, and parent/child splitting, and why a policy split mid-sentence is a bug you will never see in a metric.
