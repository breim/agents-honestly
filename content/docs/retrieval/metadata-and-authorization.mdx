...
Next: [Lexical Search and Why You Still Need It](/book/retrieval/lexical-search), on BM25, exact match, and the ticket ID that semantic search will never find.
