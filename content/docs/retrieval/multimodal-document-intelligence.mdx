...
Part IV has now built every route it named, and no way to say whether any of them works. Next: [Evaluating Retrieval](/book/retrieval/retrieval-evals), on the ceiling retrieval sets, which no generator can raise.
