...
Part IV can now measure everything it built, and one of the four tickets still has no route. Next: [When Relationships Are the Query](/book/graphs/when-relationships-are-the-query), Part V, and the questions similarity search cannot reach by construction.
