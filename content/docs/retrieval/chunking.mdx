...
A chunk carries more than its text. It carries who was allowed to read the document it came from. Next: [Metadata Is Authorization](/book/retrieval/metadata-and-authorization), where the filter everyone introduces as a relevance trick turns out to be doing security work.
