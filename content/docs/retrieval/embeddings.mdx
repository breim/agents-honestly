...
Next: [Vector Search and the Database Question](/book/retrieval/vector-search), starting with Postgres and pgvector, because it forces you to see vector search as a capability rather than a product.
