...
All of this ranks documents, and one of Atlas's four tickets does not want a document. Next: [SQL Is Still the Answer](/book/retrieval/sql-is-still-the-answer), because a quarter's tonnage is a computation, and top-k over rows is not one.
