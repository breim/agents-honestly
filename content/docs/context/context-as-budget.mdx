...
One claimant is always three times what you assumed, and the first place to look is the one you wrote yourself. Next: [The System Prompt](/book/context/system-prompt), re-paid in full on every request, and usually older than the model now reading it.
