...
Memory is what you chose to keep. History is what accumulates whether you chose it or not. Next: [Compaction and Summarization](/book/context/compaction), on rewriting it before it eats the window, without losing the thing you needed.
