...
Next: [Memory: Short-Term, Long-Term, and Neither](/book/context/memory), on thread state, durable user facts, and the knowledge base: three different things that people put in one vector store.
