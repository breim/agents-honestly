...
[Process Discovery and Value](/docs/foundations/process-discovery-and-value) develops that method. It also requires the project to name exit criteria before a convincing demo makes stopping politically difficult.
...
[Part IV](/docs/retrieval/where-does-the-answer-live) is this table with the reasoning attached. It is, per page, probably the most cost-saving chapter in the book.
...
Next: [How to Read This Book](/docs/how-to-read), or straight into [What an Agent Actually Is](/docs/foundations/what-is-an-agent).
