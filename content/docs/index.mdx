...
<Cards>
  <Card title="Start at the beginning" href="/book/preface">
    The Preface covers who this is for and what you'll build.
  </Card>
  <Card title="See the whole thing first" href="/book/the-map">
    The Map puts every layer on one page and names which one owns which decision.
  </Card>
  <Card title="You're in a hurry" href="/book/core-path">
    The Core Path is the shortest route that still leaves you able to ship.
  </Card>
  <Card title="Something is broken" href="/book/patterns/durability/agent-as-entity-workflow">
