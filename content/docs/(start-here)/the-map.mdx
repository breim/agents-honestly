...
description: The whole system on one page — which layer owns which decision, and the question that routes every piece of work to the right one.
---
