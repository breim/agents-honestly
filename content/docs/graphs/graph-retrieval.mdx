...
Next: [Evaluating Graph Quality](/book/graphs/evaluating-graph-quality), on nodes, edges, paths, provenance, freshness, and whether the graph improved the answer.
