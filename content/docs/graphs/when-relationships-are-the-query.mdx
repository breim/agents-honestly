...
Next: [Entities, Relations, and Ontology](/book/graphs/modeling-entities), on deciding what a Customer is once, so five systems stop each having their own answer.
