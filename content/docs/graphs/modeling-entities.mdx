...
Every one of those is correct **locally**. Each system's definition serves its own job perfectly well. The trouble starts the moment [Atlas](/book/preface#what-youll-build) is asked something that spans them, like "why is Acme at risk," which requires the CRM's Acme, support's Acme, and the warehouse's Acme to be the same Acme.
