...
The graph is coherent. It is also far too large to hand to a model. Next: [Graph Retrieval](/book/graphs/graph-retrieval), on walking it and coming back with a subgraph that fits in a prompt.
