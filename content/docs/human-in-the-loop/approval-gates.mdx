...
Next: [LangGraph Interrupts vs. Temporal Signals](/book/human-in-the-loop/interrupts-vs-signals), two mechanisms for the same pause. Which one owns the wait, and what happens when both think they do.
