...
Every mechanism here assumes the person answers. Next: [Escalation, Timeouts, and Audit Trails](/book/human-in-the-loop/escalation-and-audit), for the case where nobody does, and for proving months later what happened instead.
